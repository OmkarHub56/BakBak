...
public class GroupChatsAdapter extends RecyclerView.Adapter{
    ...
    int SENDER_VIEW_TYPE=1,RECEIVER_VIEW_TYPE=2,RECEIVER_CONT_VIEW_TYPE=3;
    FirebaseAuth auth;
...
//        this.listener=listener;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType==SENDER_VIEW_TYPE){
            ...
            View view=LayoutInflater.from(context).inflate(R.layout.sample_group_receiver_cont,parent,false);
